package org.servicebroker.sourcecontrol.model;

import org.openpaas.servicebroker.model.Plan;
import org.openpaas.servicebroker.model.ServiceDefinition;
import org.servicebroker.sourcecontrol.TestConstants;
...
public class ServiceDefinitionFixture {
    ...
    public static ServiceDefinition getService() {
        ...
        return new ServiceDefinition(
                ...
                "A Application Platform source control service for application development.provision parameters : parameters {owner_id : {ownerid}, org_name:{organizationName}}",
                false,
                false,
                Arrays.asList(
                        new Plan(TestConstants.SERVICEDEFINITION_PLAN_ID,
                                ...
                                null)),
                Arrays.asList("ap-sourcecontrol"),
                getMetadata(),
                null,
                null);
    }
