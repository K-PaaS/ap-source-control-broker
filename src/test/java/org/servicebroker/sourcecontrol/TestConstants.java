...
public class TestConstants {
    ...
    public static final String PARAM_KEY_ORGNAME = "org_name";

    public static final String SERVICEDEFINITION_ID = "ap-sourcecontrol-service-id";
    public static final String SERVICEDEFINITION_NAME = "p-ap-sourcecontrol";
